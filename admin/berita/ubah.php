...
$search = mysqli_query($koneksi, "SELECT * FROM berita WHERE id_berita = '$id_berita'");
    ...
    <div class="pcoded-content">
        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="proses_ubah.php?id_berita=<?= $id_berita ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="../assets/images/berita/<?= $item['foto'] ?>" width="100px" alt="">
